...
class WebflowWebhookController(http.Controller):
    ...
    #     try:
    #         allowed_keys = [
    #             "fbf3d97bc6ff738b1ae334e2b9738e50f00e2c350402c61a62442cdd9251b762",  # local key
    #             "40d7fb06aa9a305b74c0f818e691704475f0fafc5bd349d95a84182396482d7a",   # staging key
    #         ]

    #         incoming_key = request.httprequest.headers.get('X-Webhook-Secret')

    #         if incoming_key not in allowed_keys:
    #             _logger.warning("Unauthorized webhook attempt blocked.")
    #             return request.make_response(
    #                 json.dumps({"status": "unauthorized"}),
    ...
    #                 _logger.warning("Created New Branch: %s", branch_company.name)

    #                 # Give admin access automatically
    #                 self._give_admin_branch_access(branch_company)

    #         if not branch_company:
    #             branch_company = request.env['res.company'].sudo().browse(1)
    ...
    #         _logger.warning("Lead Values Being Created:\n%s", json.dumps(lead_vals, indent=4))
